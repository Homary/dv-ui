    ...
    export default {
        ...
        data() {
            return {
                ...
                verticalCur: false,
                horizontalCur: false,
                width: this.vWidth || '100%',
                height: this.vHeight || '100%',
            }
        },
        computed: {
            contentStyle: function () {
                return {
                    ...
                    height: '[object] string' === Object.prototype.toString.call(this.height) ? this.height : this.height + 'px',
                    left: (this.barHWidth - this.offX) / 2 + 'px'
                }
            }
        },
        methods: {
                ...
                if (this.horizontal) {
                    ...
                    if (this.listW < this.refWrap.offsetWidth) {
                        ...
                        this.$nextTick(() => {
                            ...
                            this.barHWidth = this.refWrap.offsetWidth;
                            this.offX = offX;
                            this.barHMain.style.width = offX + 'px';
                            if (this.pattern === 'center') {
                                this.barHMain.style.left = (this.refWrap.offsetWidth - offX) / 2 + 'px';
                                this.mouse.nowX = (this.refWrap.offsetWidth - offX) / 2;
                            }
...
<style lang="less" scoped>
    ...
    .scroll-bar-h .scroll-bar-h-main {
        ...
        height: 100%;
        border-radius: 5px;
        background-color: rgba(248, 10, 10, 0.5);
        cursor: pointer;
        z-index: 100;
    }
